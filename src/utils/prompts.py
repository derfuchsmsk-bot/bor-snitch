...
4. СТИЛЬ И ГРАММАТИКА:
   - ОДНО ПОЛНОЦЕННОЕ предложение. Подлежащее + сказуемое.
   - ЗАПРЕЩЕНО: Обрывки фраз ("Тот, кто...", "Когда ты..."). Мысль должна быть законченной.
   - ЗАПРЕЩЕНО: Сложные причастные обороты. Пиши просто, как в чате.
   - Без "Ха-ха", "Ну...", "Слушай...".
</instructions>
"""
